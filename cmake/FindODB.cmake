# SRC: https://github.com/BtbN/OdbCmake/blob/master/cmake/Modules/FindODB.cmake
# MODIFIED: Addess support on windows
...
if (LINUX)
    ...
    set(FIND_NAMES_SUFFIXE "odb/.libs/")
endif()
...
function(find_odb_api component)
        ...
        if (WIN32)
            set(PATH_SUFFIXE_COMPONENT, "odb/${component}/.libs/")
        else()
        ...
        find_library(ODB_${component}_LIBRARY
                ...
                PATH_SUFFIXES
                ${PATH_SUFFIXE_COMPONENT})
            message("ODB_${component}_LIBRARY ${ODB_${component}_LIBRARY}")
...
find_package_handle_standard_args(ODB
        ...
        HANDLE_COMPONENTS)
    message("ODB_LIBODB_FOUND ${ODB_LIBODB_FOUND}")
    message("ODB_LIBODB_LIBRARIES ${ODB_LIBODB_LIBRARIES}")
